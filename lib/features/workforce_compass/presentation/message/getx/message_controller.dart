...
import '../../../../../core/utils/app_socket_client.dart';
...
import '../../../data/models/request/notification/notification.dart';
import '../../../data/models/response/chat/chat_model.dart';
import '../../../data/models/response/message/message_content_model.dart';
...
import '../../chat/getx/chat_controller.dart';
...
class MessageController extends GetxController {
  ...
  void onClose() {
    ...
    if(Get.previousRoute == AppRoutes.task){
  ...
  void connectSocket() {
    if(Get.previousRoute == AppRoutes.base){
      ...
      debugPrint('initialized socketIO');
    }
