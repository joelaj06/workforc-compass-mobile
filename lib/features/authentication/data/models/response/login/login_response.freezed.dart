...
mixin _$LoginResponse {
  @JsonKey(name: 'user_token_validation')
...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'user_token_validation') User user});
...
class _$_LoginResponse extends _LoginResponse {
  const _$_LoginResponse(
      {@JsonKey(name: 'user_token_validation') required this.user})
      : super._();
...
abstract class _LoginResponse extends LoginResponse {
  const factory _LoginResponse(
          {@JsonKey(name: 'user_token_validation') required final User user}) =
      _$_LoginResponse;
